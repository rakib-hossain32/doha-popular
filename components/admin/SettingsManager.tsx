  ...
  return (
    <div className="max-w-4xl space-y-10 pb-20">
      <div className="space-y-1">
        ...
        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Global parameters for Doha Popular digital infrastructure</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="e.g. Doha Popular Management"
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="info@dohapopular.com.qa"
                />
              </div>
            </div>
          </div>
