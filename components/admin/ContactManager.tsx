            ...
            >
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-10">
                <div className="space-y-8 flex-1">
                  ...
                  <div className="p-8 bg-slate-900 rounded-4xl relative group-hover:bg-slate-950 transition-colors duration-700 shadow-xl overflow-hidden min-h-[140px]">
                ...
                <div className="flex lg:flex-col justify-between items-start lg:items-end gap-6 min-w-[180px]">
