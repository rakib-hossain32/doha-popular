...
const reasons = [
  {
    ...
    desc: "24/7 dedicated support and rapid response teams for urgent corporate needs in Doha.",
    icon: ShieldCheck,
    color: "text-blue-600",
    bg: "bg-blue-50"
  },
  ...
  },
  {
    ...
    desc: "ISO Certified processes adapted for the unique and demanding Qatari landscape.",
    icon: Trophy,
    color: "text-rose-600",
    bg: "bg-rose-50"
  }
