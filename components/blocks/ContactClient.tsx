...
const contactMethods = [
  {
    ...
    content: "+974 4400 0000 / +974 7700 0000",
    tag: "24/7 Priority",
    color: "text-blue-600",
    bg: "bg-blue-50"
  },
  ...
  },
  {
    ...
    content: "Sun - Thu: 08:00 AM - 06:00 PM",
    tag: "GMT +3",
                 ...
                 {contactMethods.map((item, i) => (
                   ...
                   >
                     ...
                     <div>
                        ...
                        <p className="text-base font-black text-accent group-hover:text-primary transition-colors">{item.content}</p>
                     </div>
                   </motion.div>
                 ))}
               </motion.div>
