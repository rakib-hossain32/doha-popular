...
export default function CareersPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <PageHero 
        badge="Join Doha Popular"
        title="Forge Your"
        highlight="Career Path."
        description="We are constantly seeking tier-one talent to help us manage Qatar's most iconic infrastructure projects."
        watermark="Careers"
        centered
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
             ...
             <p className="text-slate-500 font-medium leading-relaxed">We don't just offer jobs; we offer a seat at the table of Qatar's infrastructure evolution.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-12">
              <div className="space-y-4">
                 ...
                 <p className="text-slate-500 text-lg font-medium max-w-md">We are actively sourcing candidates for the following core divisions across Doha and Lusail.</p>
              </div>
                ...
                {submitted ? (
                  ...
                  <>
                    <div className="space-y-2">
                       ...
                       <p className="text-white/40 text-xs font-bold uppercase tracking-[0.2em]">Start your professional journey with Doha Popular</p>
                    </div>
      ...
      <section className="py-12 bg-slate-50 border-y border-slate-100 mb-20">
         <div className="container px-4 mx-auto">
            <div className="flex flex-wrap justify-center gap-12 md:gap-24 opacity-30 grayscale saturate-0">
               ...
               <div className="flex items-center gap-3"><Briefcase className="size-10" /><span className="text-xl font-black uppercase tracking-tight">Qatar National Vision 2030</span></div>
            </div>
         </div>
      </section>
    </main>
