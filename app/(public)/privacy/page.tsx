  ...
  const policies = [
    {
      ...
      description: "Doha Popular collects minimal information required to provide premium services. This includes contact details for briefing requests and technical telemetry during portal interaction to optimize your experience."
    },
    {
      icon: Database,
      title: "Secure Architecture",
      description: "All sensitive client data is stored on encrypted, sovereign cloud infrastructure by Doha Popular. We employ military-grade security protocols to ensure your institutional information remains a closed-circuit asset."
    },
    {
      icon: UserCheck,
      title: "User Rights",
      description: "You retain full control over your digital footprint. Under Qatari Data Privacy protection laws, you may at any time request access to, correction of, or deletion of your personal records."
    },
    {
      icon: Globe,
      title: "Third-Party Sharing",
      description: "Doha Popular Management never commoditizes your data. We share information only with authorized government entities or strategic partners strictly as required for operational mission success."
    },
    {
      icon: Cookie,
    ...
    },
    {
      ...
      description: "For any privacy-related inquiries or technical data audits, please contact our Legal Data Officer directly at privacy@dohapopular.com.qa. We respond to all formal requests within 48 operational hours."
    }
  ];
