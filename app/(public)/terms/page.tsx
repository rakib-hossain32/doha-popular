  ...
  const sections = [
    {
      ...
      content: "By accessing or using Doha Popular Management services, you agree to be bound by these Terms of Service and all applicable laws and regulations in the State of Qatar. If you do not agree with any of these terms, you are prohibited from using or accessing our institutional portal."
    },
    {
      icon: ShieldCheck,
    ...
    },
    {
      ...
      content: "All content, including architectural photography, technical briefs, and proprietary methodology displayed on this site, is the exclusive property of Doha Popular Management. Unauthorized reproduction or commercial use is strictly prohibited."
    },
    {
      icon: Lock,
    ...
    },
    {
      icon: Gavel,
      title: "Governing Law",
      content: "Any claim relating to Doha Popular Management's services shall be governed by the laws of Qatar without regard to its conflict of law provisions. Disputes shall be resolved exclusively within the jurisdiction of Qatari courts."
    },
    {
      icon: AlertCircle,
      title: "Modifications",
      content: "Doha Popular Management reserves the right to revise these terms at any time without notice. By using this website, you are agreeing to be bound by the then-current version of these Terms of Service."
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-white">
      <PageHero 
        ...
        title="Terms of"
        highlight="Service."
        description="Our operational framework and legal boundaries for delivering premium facility management across Qatar's iconic landscape."
        watermark="Legal"
        centered
