    ...
    if (adminEmail) {
      const emailHtml = `
        <div style="font-family: sans-serif; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
          <h2 style="color: #8A1538;">New Corporate Inquiry Received</h2>
          ...
          <hr />
          <p style="font-size: 12px; color: #666;">This is an automated notification from your Doha Popular website Quick Request form.</p>
        </div>
      `;
